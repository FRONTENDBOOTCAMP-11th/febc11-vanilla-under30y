class NikeHeader extends HTMLElement {
    ...
    <div class="header">
      ...
      />
      <img
        src="../images/icons/IconProfile.svg"
        alt="프로필"
        class="header--img profile"
      />
      <img
        src="../images/icons/IconCart.svg"
        alt="장바구니"
        class="header--img cart"
      />
      <button id="menuToggle" class="header--img menu">
        <img src="../images/icons/IconMenu.svg" alt="메뉴" />
      </button>
      <!-- 아래부터 메뉴 내부 디자인 -->
      <div id="overlay"></div>
      <div id="sideMenu" class="menu-list">
        <div class="menu-header">
          <button class="menu-exit" id="menu-exit">
            <img src="../images/icons/IconClose.svg" alt="닫기 버튼" />
          </button>
        ...
        <div class="menu-content">
          <button class="content__button new" id="newfeatured">
            <h1>New & Featured</h1>
            <img src="../images/icons/IconNext.svg" alt="다음 버튼" />
          </button>
        ...
        <div id="submenu" class="submenu">
          <div class="submenu-header">
            <button class="submenu-backbutton" id="backbutton">
              <img src="../images/icons/IconBack.svg" alt="뒤로 가기 버튼" />
              <h2>전체</h2>
            </button>
        ...
        <div class="menu-footer">
          <button class="footer__button">
            <img src="../images/icons/IconCs.svg" alt="고객센터 버튼" />
            <h1>고객센터</h1>
          </button>
          <button class="footer__button cart">
            <img src="../images/icons/IconCart.svg" alt="장바구니 버튼" />
            <h1>장바구니</h1>
          </button>
          <button class="footer__button">
            <img src="../images/icons/IconOrder.svg" alt="주문 버튼" />
            <h1>주문</h1>
          </button>
          <button class="footer__button">
            <img src="../images/icons/IconStore.svg" alt="매장찾기 버튼" />
            <h1>매장 찾기</h1>
          </button>
        </div>
      </div>
